package cn.daiv.share.generator;

import cn.daiv.share.generator.bean.Entity;
...
import static cn.daiv.share.generator.XbootGenerator.*;
...
public class XbootMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.daiv.share.modules.your.entity";

    /**
     * dao对应包 【注意修改后需到cn.daiv.share.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.daiv.share.modules.your.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.daiv.share.modules.your.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.daiv.share.modules.your.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.daiv.share.modules.your.controller";
