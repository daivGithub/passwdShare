package cn.daiv.share.generator.vue;
...
import cn.daiv.share.generator.bean.Field;
...
@RequestMapping(value = "/share/generate")
public class XbootVueGenerator {
    ...
    public Result<Object> generateTable(@PathVariable String vueName,
        ...
        // IP限流 在线Demo所需
        String token = redisRaterLimiter.acquireToken("generate:"+ipInfoUtil.getIpAddr(request), 1, 86400000);
