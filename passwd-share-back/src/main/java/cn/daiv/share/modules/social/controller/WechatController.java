...
import cn.daiv.share.modules.social.vo.AccessToken;
import cn.daiv.share.modules.social.vo.WechatUserInfo;
...
@RequestMapping("/share/social/wechat")
@Controller
public class WechatController {

    @Value("${share.social.wechat.appId}")
    private String appId;

    @Value("${share.social.wechat.appSecret}")
    private String appSecret;

    @Value("${share.social.wechat.callbackUrl}")
    private String callbackUrl;

    @Value("${share.social.callbackFeUrl}")
    private String callbackFeUrl;

    @Value("${share.social.callbackFeRelateUrl}")
