...
import cn.daiv.share.modules.social.vo.GithubUserInfo;
...
@RequestMapping("/share/social/github")
@Controller
public class GithubController {

    @Value("${share.social.github.clientId}")
    private String clientId;

    @Value("${share.social.github.clientSecret}")
    private String clientSecret;

    @Value("${share.social.github.callbackUrl}")
