...
import cn.daiv.share.modules.social.vo.WeiboUserInfo;
...
@RequestMapping("/share/social/weibo")
@Controller
public class WeiboController {

    @Value("${share.social.weibo.appKey}")
    private String appKey;

    @Value("${share.social.weibo.appSecret}")
    private String appSecret;

    @Value("${share.social.weibo.callbackUrl}")
