...
import cn.daiv.share.modules.social.vo.QQUserInfo;
...
@RequestMapping("/share/social/qq")
@Controller
public class QQController {

    @Value("${share.social.qq.appId}")
    private String appId;

    @Value("${share.social.qq.appKey}")
    private String appKey;

    @Value("${share.social.qq.callbackUrl}")
