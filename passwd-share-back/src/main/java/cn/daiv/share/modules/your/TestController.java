package cn.daiv.share.modules.your;

import cn.daiv.share.common.annotation.RateLimiter;
import cn.daiv.share.common.lock.Callback;
import cn.daiv.share.common.lock.RedisLockTemplate;
...
@Transactional
@RequestMapping(value = "/share/test")
