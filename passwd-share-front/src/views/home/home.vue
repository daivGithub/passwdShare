...
<template>
  <div>
    <div v-show="currNav=='share'" class="home">
      <Row :gutter="10">
        <Col :lg="24" :xl="8">
          <Row :gutter="10">
            ...
            <Col :lg="12" :xl="24" style="margin-bottom: 10px;">
              <Card>
                <p slot="title">
                  ...
                  <a href="https://github.com/Daiv/x-boot" target="_blank">XBoot开源版本地址</a>
                </p>
                <p slot="extra">
                  <a target="_blank" href="http://daiv.cn">作者：Daiv</a>
                </p>
                <div style="height: 268px;">
                  <Timeline>
                    ...
                    <TimelineItem>
                      ...
                      <a href="https://github.com/Daiv/Machine-Learning" target="_blank">个人机器学习笔记</a>
                    </TimelineItem>
                    <TimelineItem>
                      <Icon type="md-cart" color="#f4364c" slot="dot"></Icon>
                      <a href="http://xmall.daiv.cn" target="_blank">XMall开源分布式商城</a>
                    </TimelineItem>
                    <TimelineItem>
                      <Icon type="md-cash" color="#19be6b" slot="dot"></Icon>
                      <a href="http://xpay.daiv.cn" target="_blank">XPay开源个人免签支付系统</a>
                    </TimelineItem>
                    <TimelineItem>
            ...
            <Col :lg="24" :xl="12" style="padding: 0 5px 10px 0;">
              <Card>
                <p slot="title" style="overflow:visible">
                  <a href="http://xpay.daiv.cn/pay?share" target="_blank">
                  ...
                  <div class="qr">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        target="_blank"
                      >XMall小程序(不含后台)</a> +
                      <a href="https://github.com/Daiv/xpay" target="_blank">最新XPay个人收款支付系统</a>
                    </div>
                  </div>
                  <div class="flex">
                    完整版(仅供学习)：
                    ...
                    <Button
                      to="http://xpay.daiv.cn/pay?share"
                      target="_blank"
                      type="error"
                      icon="md-paper-plane"
    ...
    <div v-show="currNav=='doc'||currNav=='share-show'||currNav=='xpay'||currNav=='xmall'">
      <show />
    </div>
